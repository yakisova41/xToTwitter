...
export type LangData = Record<Langs, Messages>;
export type Messages = Record<string, string | null>;

export const i18n: LangData = {
  "ar-x-fm": {
    f70a36d0: "تغريد الكل",
    ...
    hb7b0cea:
      'return e.retweetCount+" إعاد"+n(e.retweetCount,"ات","ة","ة","ة","تا","ة")+" تغريد"',
    ...
    d6917e0c:
      'return"عرض "+e.count+" تغريد"+n(e.count,"ات","ة","ة","ة","تين","ة")',
    e2414185: null,
    hb7b0ceb: null,
    bd7c0390: null,
    bea869b4: null,
  ...
  bn: {
    ...
    hb7b0cea:
      'return e.retweetCount+" পুনঃ"+a(e.retweetCount," টুইট করুন","টুইটগুলো")',
  ...
  cs: {
    ...
    e2414184:
      'return""+n(e.count,"Tweety s citací","Tweety s citací","Citovat Tweet","Tweety s citací")',
    hb7b0cea:
      'return e.retweetCount+" Retweet"+n(e.retweetCount,"y","y","","ů")',
    ...
    d91695cb:
      'return"Uživatel "+e.fullName+" (@"+e.screenName+") tweetnul: "+e.tweet',
    d6917e0c:
      'return"Ukázat "+e.count+" "+n(e.count,"tweety","tweety","Tweet","tweetů")',
    e2414185: null,
    hb7b0ceb: null,
    bd7c0390: null,
    bea869b4: null,
  ...
  el: {
    ...
    d6c85149: "Retweet",
    d91695cb:
      'return"Ο χρήστης "+e.fullName+" (@"+e.screenName+") έγραψε το Tweet: "+e.tweet',
  ...
  eu: {
    ...
    d6c85149: "Bertxiotu",
    d91695cb:
      'return e.fullName+"(e)k (@"+e.screenName+") Txiokatu du: "+e.tweet',
    d6917e0c: 'return"Show "+e.count+" Tweet"+n(e.count,"","s")',
    e2414185: null,
    hb7b0ceb: null,
    bd7c0390: null,
  ...
  he: {
    ...
    e2414184:
      'return"צי"+c(e.count,"וץ ציטוט","טוט ציוץ","וץ ציטוט","וץ ציטוט")',
    hb7b0cea:
      'return e.retweetCount+" ציו"+c(e.retweetCount,"צים","ץ","צים","צים")+" מחדש"',
  ...
  hi: {
    ...
    d91695cb:
      'return e.fullName+" (@"+e.screenName+") ने ट्वीट किया: "+e.tweet',
  ...
  hr: {
    ...
    e2414185:
      'return""+t(e.count,"citirana tweeta","Citiraj Tweet","citiranih tweetova")',
    hb7b0ceb:
      'return e.retweetCount+" proslijeđen"+t(e.retweetCount,"a tweeta","i Tweet","ih tweetova")',
    ...
    d91695cb:
      'return e.fullName+" (@"+e.screenName+") objavio/la je Tweet: "+e.tweet',
    d6917e0d:
      'return"Prikaži "+e.count+" "+t(e.count,"tweeta","Tweet","tweetova")',
    e2414184: null,
    hb7b0cea: null,
    bd7c039f: null,
    bea869b3: null,
  ...
  ja: {
    ...
    d6c85149: "リツイート",
    d91695cb:
      'return e.fullName+"（@"+e.screenName+"）さんがツイートしました: "+e.tweet',
  ...
  kn: {
    ...
    hb7b0ceb:
      'return e.retweetCount+" ಮರುಟ್ವೀಟ"+n(e.retweetCount,"ಿಸಿ","್‌ಗಳು")',
  ...
  mr: {
    ...
    hb7b0cea:
      'return e.retweetCount+" पुन"+r(e.retweetCount,"्हा ट्विट करा","र्ट्विट्स")',
    ...
    d91695cb:
      'return e.fullName+" (@"+e.screenName+") यांनी ट्विट केले: "+e.tweet',
  ...
  pl: {
    ...
    hb7b0cea:
      'return e.retweetCount+" Tweet"+n(e.retweetCount,"y podane","ów podanych"," podany","ów podanych")+" dalej"',
  ...
  ro: {
    ...
    e2414184:
      'return""+r(e.count,"Tweeturi cu citat","Tweet cu citat","de Tweeturi cu citate")',
    hb7b0cea:
      'return e.retweetCount+" "+r(e.retweetCount,"Retweeturi","Retweet","de Retweeturi")',
    ...
    d91695cb:
      'return e.fullName+" (@"+e.screenName+") a dat Tweetul: "+e.tweet',
    d6917e0c:
      'return"Afișează "+e.count+" "+r(e.count,"Tweeturi","Dă Tweet","Tweeturi")',
    e2414185: null,
    hb7b0ceb: null,
    bd7c0390: null,
    bea869b4: null,
  ...
  ru: {
    ...
    e2414184:
      'return""+n(e.count,"твита с цитатами","твитов с цитатами","Цитировать твит","Твиты с цитатами")',
    hb7b0cea:
      'return e.retweetCount+" ретвит"+n(e.retweetCount,"а","ов","","а")',
  ...
  ta: {
    ...
    e2414185:
      'return""+n(e.count,"ட்விட்டை மேற்கோள் காட்டு","மேற்கோள் கீச்சுகள்")',
  ...
  uk: {
    ...
    e2414185:
      'return"цитован"+n(e.count,"і твіти","их твітів","ий твіт","ого твіта")',
    hb7b0ceb:
      'return e.retweetCount+" ретвіт"+n(e.retweetCount,"и","ів","","а")',
